...
colabfold_batch --template --local-pdb-path ${templates} --pdb-hit-file ${hit} --num-models 3 --use-gpu-relax --num-recycle 15 --recycle-early-stop-tolerance 0 --num-ensemble 3 --random-seed 1235892 --relax-max-iterations 4000 --amber --templates ${input_file} $LaunchDir/"AF_Complex"
